...
class SellerDetailsTest extends \PHPUnit\Framework\TestCase // Define a test class named SellerDetailsTest that extends PHPUnit's TestCase class.
{
    ...
    {
        // Arrange
        $expectedBuyersCount = 7; // Set the expected number of buyers in the database.
    ...
    private function retrieveBuyerDetails()
    {
        ...
        $query = "SELECT * FROM users WHERE role = 'seller'"; // Define the SQL query to select all users with the role 'seller'.
