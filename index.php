...
// Retrieve four products from the database
...
<nav class="top-nav-bar">
    ...
    <div class="list-right">
        <ul class="list">
            ...
            <li class="list-inline-item text-center">
                <a class="text-light text-decoration-none" href="login.php"><i class="bi bi-box-arrow-in-right"></i></i></a>
            </li>
        </ul>
    </div>
                            ...
                            <div class="col-lg-6 mb-0 d-flex align-items-center">
                                <div class="text-align-left">
                                    ...
                                    <p>
                                        ...
                                        <a href="product_page.php"> Shop it now! -> </a>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <?php while ($product = mysqli_fetch_assoc($result)) : ?>
                <div class="card">
                    <div class="card-image">
                        ...
                        $imageQuery = "SELECT * FROM image WHERE product_id = $productId";
