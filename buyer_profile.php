...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="buyer_profile_style.css" type="text/css">
    ...
    <body>
        ...
        <h2 class="title">My Buyer Profile</h2>
        ...
        <div class="container">
            ...
            <div class="seller-profile-container">
                ...
                <div class="edit">
                    ...
                    <a href="edit_buyer_profile.php?buyer_id=<?php echo $buyerId; ?>" class="edit-seller-profile-button">
