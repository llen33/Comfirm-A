...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="edit_buyer_profile_style.css" type="text/css">

        <!-- javascript link -->
        <script src="edit_buyer_profile_javascript.js"></script>
    ...
    <body>
        ...
        <nav class="top-nav-bar">
            ...
            <div class="list-right">
                ...
                <ul class="list">
                    ...
                    <li><a href="sbuyer_profile.php">Profile</a></li>
        ...
        <h2 class="title">Edit My Buyer Profile</h2>
            ...
            <div class="edit-seller-profile-form-container">
                ...
                <form name="edit-seller-profile-form" method="POST" action="" enctype="multipart/form-data" 
                    ...
                    <div class="s_firstname">     <!-- s_firstname = buyer firstname-->
                        ...
                        <input type="text" placeholder="Enter First Name" value="<?php echo $firstname; ?>" name="buyer_firstname"
                    ...
                    <div class="s_lastname">
                        ...
                        <input type="text" placeholder="Enter Last Name" value="<?php echo $lastname; ?>" name="buyer_lastname"
                    ...
                    <div class="s_email">
                        ...
                        <input type="email" placeholder="Enter Email" value="<?php echo $email; ?>" name="buyer_email"
                    ...
                    <div class="s_phone_number">
                        ...
                        <input type="tel" placeholder="Enter Phone Number" value="<?php echo $phoneNumber; ?>" pattern="[0-9]{7,15}" 
                            name="buyer_phone_number" class="phone_number" required
                    ...
                    <div class="s_home_address">
                        ...
                        <input type="text" placeholder="Enter Home Address" value="<?php echo $homeAddress; ?>" name="buyer_home_address"
                    ...
                    <div class="s_password">
                        ...
                        <p class="reset_password">Reset password? <a href="buyer_reset_password.php" class="reset_button"> Reset</a></p>
